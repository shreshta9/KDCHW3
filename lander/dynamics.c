...
void reinit_dynamics(SIM *s)
{
	...
	sdfast_state[ALIEN_XD] = 0; //0.05
	sdfast_state[ALIEN_YD] = 0; //0.02
	sdfast_state[ALIEN_ZD] = 0; //0.01
	sdfast_state[ALIEN_WX] = 0;   //0.3 / 3
	sdfast_state[ALIEN_WY] = 0;   //1.0 / 3
	sdfast_state[ALIEN_WZ] = 0;   //0.1 / 3
